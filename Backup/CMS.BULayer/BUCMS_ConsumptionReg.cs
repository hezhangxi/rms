...
//** 创建人：桂书丛
//** 类名称\文件名：BUConsumptionReg
//** 类功能：提供对消费注册操作的逻辑处理方法
...
{
    /// <summary>
    /// 业务逻辑类BUCMS_ConsumptionReg
    /// </summary>
    public class BUCMS_ConsumptionReg:IBULayer<ModelCMS_ConsumptionReg>
    {
        private readonly DACMS_ConsumptionReg dal = new DACMS_ConsumptionReg();

        #region IBULayer<ModelCMS_ConsumptionReg> 成员
        ...
        /// 创建人：桂书丛
        /// 创建日期：2013-02-22
        public VariedEnum.OperatorStatus Update(ModelCMS_ConsumptionReg model)
        {
            int tempIntValue = -5;
            try
            {
        ...
        /// 创建人：桂书丛
        /// 创建日期：2013-02-22
        public VariedEnum.OperatorStatus Insert(ModelCMS_ConsumptionReg model)
        {
            int tempIntValue = -5;
            try
            {
        ...
        #region   public VariedEnum.OperatorStatus Delete()清空
        /// <summary>
        /// 清空
        /// </summary>
        /// <returns></returns>
        public VariedEnum.OperatorStatus Delete()
        {
            int tempIntValue = -5;
            try
            {
                tempIntValue = dal.Delete();
                if (tempIntValue > 0)
                    return VariedEnum.OperatorStatus.Successed;
                else
                    return VariedEnum.OperatorStatus.Failed;
