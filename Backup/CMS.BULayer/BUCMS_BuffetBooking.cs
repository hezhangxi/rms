...
{
	/// <summary>
	/// 业务逻辑类BUCMS_BuffetBooking   
	/// </summary>
	public class BUCMS_BuffetBooking:IBULayer<ModelCMS_BuffetBooking>
	{
		private readonly DACMS_BuffetBooking dal=new DACMS_BuffetBooking();

        #region IBULayer<ModelCMS_BuffetBooking> 成员
        ...
        /// 创建人：桂书丛
        /// 创建日期：2013-02-28
        public VariedEnum.OperatorStatus Update(ModelCMS_BuffetBooking model)
        {
            int tempIntValue = -5;
            try
            {
        ...
        /// 创建人：桂书丛
        /// 创建日期：2013-02-28
        public VariedEnum.OperatorStatus Insert(ModelCMS_BuffetBooking model)
        {
            int tempIntValue = -5;
            try
            {
