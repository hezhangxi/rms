...
//** 创建人：桂书丛
//** 类名称\文件名：BURoomType
//** 类功能：提供对房间类型操作的逻辑处理方法
//** 描 述：包括基本的增、删、查、改（所有关于房间类型数据库操作的方法）
//** 创建日期：2013-1-26
//** 修改(&U)人：桂书丛
//** 修改(&U)日期：2013-1-27
//** 整理日期：2013-1-27
...
namespace CMS.BULayer
{
    ...
    /// 业务逻辑类BUCMS_RoomType   
    /// </summary>
    public class BUCMS_RoomType:IBULayer<ModelCMS_RoomType>
    {
        private readonly DACMS_RoomType dal = new DACMS_RoomType();

        #region IBULayer<ModelCMS_RoomType> 成员
        ...
        /// 创建人：桂书丛
        /// 创建日期：2013-02-22
        public VariedEnum.OperatorStatus Update(ModelCMS_RoomType model)
        {
            int tempIntValue = -5;
            try
            {
        ...
        /// 创建人：桂书丛
        /// 创建日期：2013-02-22
        public VariedEnum.OperatorStatus Insert(ModelCMS_RoomType model)
        {
            int tempIntValue = -5;
            try
            {
