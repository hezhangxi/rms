...
{
    /// <summary>
    /// 业务逻辑类BUCMS_ConsumptionDish   
    /// </summary>
    public class BUCMS_ConsumptionDish:IBULayer<ModelCMS_ConsumptionDish>
    {
        private readonly DACMS_ConsumptionDish dal = new DACMS_ConsumptionDish();

        #region IBULayer<ModelCMS_ConsumptionDish> 成员
        ...
        /// 创建人：桂书丛
        /// 创建日期：2013-02-22
        public VariedEnum.OperatorStatus Update(ModelCMS_ConsumptionDish model)
        {
        ...
        /// 创建人：桂书丛
        /// 创建日期：2013-02-22
        public VariedEnum.OperatorStatus Insert(ModelCMS_ConsumptionDish model)
        {
            int tempIntValue = -5;
            try
            {
