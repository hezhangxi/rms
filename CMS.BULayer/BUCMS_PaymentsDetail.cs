...
{
	/// <summary>
	/// 业务逻辑类BUCMS_PaymentsDetail   
	/// </summary>
	public class BUCMS_PaymentsDetail:IBULayer<ModelCMS_PaymentsDetail>
	{
		private readonly DACMS_PaymentsDetail dal=new DACMS_PaymentsDetail();
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public VariedEnum.OperatorStatus Update(ModelCMS_PaymentsDetail model)
        {
            int tempIntvalue = -5;
            try
            {
        ...
        /// 创建人：桂书丛
        /// 创建日期：2013-02-22
        public VariedEnum.OperatorStatus Insert(ModelCMS_PaymentsDetail model)
        {
            int tempIntValue = -5;
            try
            {
